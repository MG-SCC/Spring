...
namespace Spring.Controllers
{
    public class FurnituresController : Controller
    {
        ...
        public FurnituresController(SpringContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Furniture != null ? 
                          ...
                          Problem("Entity set 'SpringContext.Furniture'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Colour,Type,Price")] Furniture furniture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Colour,Type,Price")] Furniture furniture)
        {
            if (id != furniture.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SpringContext.Furniture'  is null.");
            }
            var furniture = await _context.Furniture.FindAsync(id);
            if (furniture != null)
            {
